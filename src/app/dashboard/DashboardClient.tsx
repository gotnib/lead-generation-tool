  ...
  return (
    <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
        <StatCard label="Total Leads" value={stats.total} accent="text-zinc-100"
        ...
        <StatCard label="Contacted" value={stats.contacted} accent="text-amber-400"
        ...
        <StatCard label="Interested" value={stats.interested} accent="text-violet-400"
        ...
        <StatCard label="Closed" value={stats.closed} accent="text-emerald-400"
      ...
      {leads.length === 0 && (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-800 py-20 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Use <Link href="/dashboard/scraper" className="text-blue-400 hover:underline">Find Leads</Link> to populate your pipeline.
          </p>
        </div>
      )}
